...
def outlook_copy_folder(access_token, folder_1, folder_2):
    ...
    try:
        ...
        if count_2 == len(folders):
            ...
            folders[folder_index_1].copy_into(folders[folder_index_2])
...
result = outlook_copy_folder(access_token, folder_1, folder_2)
print(result)
