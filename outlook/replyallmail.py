...
def outlook_reply_all_mail(access_token, mail_subject, reply_message, message_id_value):
    ...
    try:
        ...
        if count == len(email_subjects):
            ...
            email_subjects[index].reply_all(reply_message)
...
result = outlook_reply_all_mail(access_token, mail_subject, reply_message, message_id_value)
print(result)
