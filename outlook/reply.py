...
def outlook_reply_mail(access_token, mail_subject, reply_message, message_id_value):
...
mail_subject = 'Test'
reply_message = 'Yes they are working good'
message_id_value = 'AQMkADAwATMwMAItYTBiMy1iYzc0LTAwAi0wMAoARgAAAwpkTC5OnHFLmUE-GNnP0cgHAFjVNSxktD9EjC2nUzdbESQAAAIBDAAAAFjVNSxktD9EjC2nUzdbESQABGbcy94AAAA='

result = outlook_reply_mail(access_token, mail_subject, reply_message, message_id_value)
print(result)
