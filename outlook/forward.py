...
def outlook_forward_mail(access_token, mail_subject, forward_to, message_id_value):
    ...
    try:
        ...
        if count == len(email_subjects):
            ...
            email_subjects[index].forward([pyOutlook.Contact(forward_to)])
...
result = outlook_forward_mail(access_token, mail_subject, reply_message, message_id_value)
print(result)
